...
#
# Generated by export_simulation on Sun Nov 26 18:35:19 +0530 2023
#
################################################################################
...
'-reset_run' switch to the './window_multiplier.sh' script.

./window_multiplier.sh -reset_run
...
./window_multiplier.sh -noclean_files

For more information on the script, please type './window_multiplier.sh -help'.
