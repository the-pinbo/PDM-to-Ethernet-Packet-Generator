...
HD_PWD='C:/Users/inba2/Desktop/DDFPGA/TermProject/ddfpga-project/project/efsm.runs/window_multiplier_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log window_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source window_multiplier.tcl
